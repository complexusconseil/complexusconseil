/* ==========================================================================
   NBA My Era — Époques historiques (règles + effectifs légendaires)
   --------------------------------------------------------------------------
   ⚠️ BEST-EFFORT : rosters de stars curés par époque (rotation ~6-7 joueurs),
   notes indicatives. Certaines franchises portent leur nom d'époque (voir
   ERA_TEAM_META). Les règles adaptent la simulation (ligne à 3 pts, rythme…).
   Les époques utilisent un tableau de playoffs unique (8 qualifiés).
   ========================================================================== */
...
const ERAS = {
  ...
  e2016: {
    ...
    teams: ['GSW', 'CLE', 'SAS', 'OKC', 'TOR', 'LAC', 'MIA', 'BOS', 'ATL', 'HOU', 'POR', 'IND'],
  ...
  e1996: {
    ...
    teams: ['CHI', 'OKC', 'ORL', 'HOU', 'SAS', 'UTA', 'LAL', 'NYK', 'IND', 'PHX', 'POR', 'PHI'],
  ...
  e1986: {
    ...
    teams: ['BOS', 'LAL', 'PHI', 'MIL', 'HOU', 'DET', 'ATL', 'DAL', 'POR', 'DEN', 'UTA', 'PHX'],
  ...
  e1968: {
    ...
    teams: ['BOS', 'PHI', 'LAL', 'NYK', 'DET', 'ATL', 'GSW', 'SAC'],
...
const ERA_ROSTERS = {
  ...
  e1968: {
    BOS: [ { n: 'Bill Russell', pos: 'C', ovr: 94, age: 34 }, { n: 'John Havlicek', pos: 'SF', ovr: 90, age: 28 },
      ...
      { n: 'Don Nelson', pos: 'PF', ovr: 74, age: 27 } ],
    ...
    GSW: [ { n: 'Rick Barry', pos: 'SF', ovr: 90, age: 23 }, { n: 'Nate Thurmond', pos: 'C', ovr: 88, age: 26 },
      { n: 'Jeff Mullins', pos: 'SG', ovr: 80, age: 25 }, { n: 'Al Attles', pos: 'PG', ovr: 76, age: 31 },
      { n: 'Fred Hetzel', pos: 'PF', ovr: 74, age: 25 }, { n: 'Rudy LaRusso', pos: 'PF', ovr: 78, age: 30 } ],
    SAC: [ { n: 'Oscar Robertson', pos: 'PG', ovr: 95, age: 29 }, { n: 'Jerry Lucas', pos: 'PF', ovr: 88, age: 27 },
      { n: 'Adrian Smith', pos: 'SG', ovr: 78, age: 31 }, { n: 'Tom Van Arsdale', pos: 'SF', ovr: 78, age: 24 },
      { n: 'Connie Dierking', pos: 'C', ovr: 74, age: 31 }, { n: 'Flynn Robinson', pos: 'PG', ovr: 74, age: 26 } ],
  },
  /* ---------------------------- 1985-86 --------------------------------- */
  e1986: {
    BOS: [ { n: 'Larry Bird', pos: 'SF', ovr: 96, age: 29 }, { n: 'Kevin McHale', pos: 'PF', ovr: 90, age: 28 },
      ...
      { n: 'Scott Wedman', pos: 'SF', ovr: 74, age: 33 } ],
    LAL: [ { n: 'Magic Johnson', pos: 'PG', ovr: 95, age: 26 }, { n: 'Kareem Abdul-Jabbar', pos: 'C', ovr: 90, age: 38 },
      ...
      { n: 'Kurt Rambis', pos: 'PF', ovr: 74, age: 27 } ],
  ...
  e1996: {
    CHI: [ { n: 'Michael Jordan', pos: 'SG', ovr: 99, age: 33 }, { n: 'Scottie Pippen', pos: 'SF', ovr: 92, age: 30 },
      ...
      { n: 'Luc Longley', pos: 'C', ovr: 74, age: 27 } ],
  ...
  e2016: {
    GSW: [ { n: 'Stephen Curry', pos: 'PG', ovr: 96, age: 28 }, { n: 'Klay Thompson', pos: 'SG', ovr: 88, age: 26 },
      ...
      { n: 'Shaun Livingston', pos: 'PG', ovr: 76, age: 30 } ],
    CLE: [ { n: 'LeBron James', pos: 'SF', ovr: 96, age: 31 }, { n: 'Kyrie Irving', pos: 'PG', ovr: 88, age: 24 },
      ...
      { n: 'Iman Shumpert', pos: 'SG', ovr: 74, age: 26 } ],
    SAS: [ { n: 'Kawhi Leonard', pos: 'SF', ovr: 90, age: 24, pot: 95 }, { n: 'LaMarcus Aldridge', pos: 'PF', ovr: 86, age: 31 },
      ...
      { n: 'Patty Mills', pos: 'PG', ovr: 74, age: 28 } ],
    OKC: [ { n: 'Kevin Durant', pos: 'SF', ovr: 95, age: 28 }, { n: 'Russell Westbrook', pos: 'PG', ovr: 92, age: 28 },
      ...
      { n: 'Dion Waiters', pos: 'SG', ovr: 76, age: 25 } ],
